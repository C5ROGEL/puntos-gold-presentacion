...
export const slidesData = [
  ...
  {
    id: 2.5, // lo inserta entre slide 2 y 3
    type: "content",
    title: "Por qué Puntos Gold como caso de estudio",
    sections: [
      {
        heading: "Escenario Ideal para la Comparativa",
        content:
          "Puntos Gold es un proyecto multiplataforma (iOS + Android) con requisitos de rendimiento moderado a alto, interfaz interactiva y acceso a características nativas. Esto lo hace perfecto para evaluar:",
        items: [
          "✓ Rendimiento en operaciones de UI complejas",
          "✓ Experiencia de desarrollo y velocidad de entrega",
          "✓ Integración con APIs backend (.NET 8)",
          "✓ Mantenibilidad y escalabilidad del código",
          "✓ Acceso a características del dispositivo (notificaciones, almacenamiento)",
        ],
      },
      {
        heading: "Decisión de Tecnología",
        content:
          "El proyecto fue desarrollado en Flutter con Firebase, pero exploraremos cómo cambiaría la arquitectura y el resultado si hubiese sido implementado en SwiftUI (solo iOS) o React Native (multiplataforma con JavaScript).",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        content:
          "Las PyMEs enfrentan dificultades para competir con grandes cadenas que utilizan sistemas de fidelización digitales. Los métodos tradicionales como tarjetas físicas son poco prácticos y no generan una experiencia moderna. Surge así la oportunidad de implementar una solución tecnológica accesible que fortalezca la relación con los clientes y estimule la lealtad.",
      },
      {
        heading: "2. Problema e Hipótesis",
        content:
          "Los negocios locales tienen baja retención de clientes debido a la ausencia de programas digitales de recompensas. Se plantea que la implementación de la app Puntos Gold permitirá aumentar la fidelización al ofrecer un sistema de puntos, canjes y promociones en tiempo real, contribuyendo a la competitividad de las PyMEs.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        content:
          "Desarrollo e implementación de una aplicación móvil multiplataforma en Flutter para gestionar programas de lealtad y promociones entre comercios y usuarios bajo la marca Puntos Gold.",
      },
      {
        heading: "4. Objetivos",
        subsections: [
          {
            title: "General:",
            content:
              "Crear una plataforma móvil sólida y escalable que centralice la administración de promociones, canjes y puntos para usuarios y negocios.",
          },
          {
            title: "Específicos:",
            items: [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        heading: "Limitantes:",
        content:
          "Solo versión móvil (sin panel web), sin reportes avanzados, automatizaciones limitadas y Cloud Functions básicas.",
      },
    ],
  },
  {
    ...
    sections: [
      {
        ...
        content:
          "Puntos Gold es una plataforma para que las PyMEs gestionen programas de fidelización mediante puntos acumulables y canjeables.",
        subsections: [
          {
            title: "Incluye:",
            items: [
  ...
  },
  {
    ...
    columns: [
      ...
      },
      {
        ...
        content:
          "Modelo cliente-servidor con: App móvil, API REST, Base de datos, Panel web. Permite modularidad, mantenibilidad y crecimiento futuro.",
      },
      {
    ...
    sections: [
      {
        ...
        content:
          "La implementación se desarrolla en fases estratégicas con metodología ágil Scrum:",
        subsections: [
          {
            title: "Fase 1 – Planificación",
            content:
              "Definición de requerimientos, roles, cronograma y configuración de entornos (GitHub/Azure DevOps)",
          },
          {
            title: "Fase 2 – Desarrollo del prototipo",
            content:
              "Construcción de la app en Flutter, integración con Firebase, creación del backend en .NET 8 y conexión a SQL Server",
          },
          {
            title: "Fase 3 – Pruebas y validación",
            content:
              "Pruebas unitarias, integración y piloto con comercios reales",
          },
          {
            title: "Fase 4 – Despliegue y mantenimiento",
            content:
              "Publicación en Google Play Store, hosting en Azure, soporte y actualizaciones periódicas",
          },
        ],
      },
    ],
